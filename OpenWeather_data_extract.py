...
def get_df_hourly_weather_data(latitude_2dec, longitude_2dec, start_date, end_date): 
	...
	params = {
		"latitude": latitude_2dec,
		"longitude": longitude_2dec,
	...
	# return all numpy arrays in a pandas dataframe 
...
if __name__ == "__main__" :
	...
	latitude_2dec = input("Enter a latitude (INT): ")
	longitude_2dec = input("Enter a longitude (INT): ")
	start_date = input("Enter a start date (yyyy-MM-DD): ")
	end_date = input("Enter an end date (yyyy-MM-DD): ")

	print(get_df_hourly_weather_data(latitude_2dec, longitude_2dec, start_date, end_date))
